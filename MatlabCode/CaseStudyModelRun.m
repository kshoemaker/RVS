function [numVar, numError, MargGam, mu01f, mu02f, mu01_gam, mu02_gam, ...
    GammaBI, ClassAUC, tpr_class, fpr_class, misclas] = ...
CaseStudyModelRun(X, Xf, Y, Yf, N, n_iter, ...
         bi, a, b, ak, bk, ...
...
% c = 0.6;   % gets passed to the function,  used for computing bj 
