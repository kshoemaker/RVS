...
% [X, Xf, Y, Yf, N] = simdata(100, 0.5, 4, 100, [1,-1], 1);
...
[Yf, PostProb, yhat, label, score, numVar, numError, MargGam, mu01f, mu02f, mu01_gam, mu02_gam, GammaBI, VS_AUC, ClassAUC, tpr_class, fpr_class, misclas,  ...
          lasso_coef, VSAUC_Lasso, ClassAUC_Lasso, misclas_lasso, tpr_class_lasso, fpr_class_lasso] = ...
ModelRun(p1, p2, X, Xf, Y, Yf, N, n_iter, bi, a, b, ak, bk, alpha_0, alpha_1, c, feature_thresh);

[Yf PostProb(:,2) yhat score(:,2)]
if informed == 1
   type = "informative";
elseif informed == 0
    type = "noninformative";
...
save(file_name, 'numVar', 'numError', 'MargGam', 'mu01f', 'mu02f', "GammaBI", 'VS_AUC', 'ClassAUC', 'tpr_class', 'fpr_class', ... 
        'misclas', 'lasso_coef', 'VSAUC_Lasso','ClassAUC_Lasso', 'misclas_lasso', 'misclas_svm', 'tpr_class_lasso', 'fpr_class_lasso');
